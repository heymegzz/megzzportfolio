...
- **Serverless Contact Form**: Fully functional email delivery system using Vercel & Resend.
...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/heymegzz/portfolio.git
    cd portfolio
    ```
...
- **GitHub**: [github.com/heymegzz](https://github.com/heymegzz)
