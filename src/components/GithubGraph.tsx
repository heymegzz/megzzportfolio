...
export function GithubGraph() {
  ...
  useEffect(() => {
    const fetchContributions = async () => {
      const cacheKey = "github_contributions_heymegzz";
  ...
  return (
    ...
    >
      ...
      <p id="github-activity-summary" className="sr-only">
        Calendar heatmap showing daily GitHub contribution counts for Meghna Nair over the last year. Scroll horizontally to inspect all weeks.
      </p>
