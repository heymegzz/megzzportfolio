...
const experiences: ExperienceData[] = [
  {
    ...
    imageZoom: 1,
    description: `
      Built and deployed responsive full-stack web applications for clients using React, Next.js, Node.js, Express, and MongoDB.
      Converted UI/UX designs into performant, production-ready websites.
      Integrated REST APIs, authentication, databases, and payment workflows where required.
  ...
  },
  {
    ...
    imageZoom: 1.5,
    description: `
      Contributed to open-source projects by building features, fixing bugs, and improving developer experience.
      Collaborated with maintainers through pull requests, code reviews, and technical discussions.
      Worked across modern full-stack technologies while following production-level development practices.
      Gained hands-on experience working in large, collaborative codebases and shipping meaningful contributions.
    `,
    tech: [
      "JavaScript",
      "TypeScript",
