...
const socialProfiles: Record<string, SocialProfile> = {
  GitHub: {
    ...
    handle: "heymegzz",
    avatar: "/avatar.png",
    bio: "Building what I'm curious about.",
    location: "India · Remote",
    stats: [],
  },
  LinkedIn: {
    name: "Meghna Nair",
    handle: "in/meghna-nair-159458227",
    avatar: "/avatar.png",
    bio: "Builder first. Everything else came from curiosity.",
    location: "India",
    stats: [],
  },
  LeetCode: {
    ...
    handle: "heymegzz",
    avatar: "/avatar.png",
    bio: "Optimized by curiosity.",
    location: "India",
    stats: [
      { value: "150+", label: "Solved" },
    ],
  },
  Codeforces: {
    name: "Meghna Nair",
    handle: "heymegzz",
    avatar: "/avatar.png",
    bio: "Competitive programming & algorithmic challenges.",
    location: "India",
    stats: [
      { value: "1000+", label: "Rating" },
      { value: "500+", label: "Solved" },
    ],
  },
};
